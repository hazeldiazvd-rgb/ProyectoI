...
Public Class DataBaseHelper
    ...
    Public Function ExecuteDataTable(query As String, parametros As List(Of SqlParameter)) As DataTable
        Dim dt As New DataTable()
    ...
    Public Function EjecutarSP_GetAllVehiculos() As DataTable
        Dim dt As New DataTable()
        Using conn As New SqlConnection(connectionString)
            Using cmd As New SqlCommand("GetAllVehiculos", conn)
                cmd.CommandType = CommandType.StoredProcedure
                Using da As New SqlDataAdapter(cmd)
                    da.Fill(dt)
                End Using
