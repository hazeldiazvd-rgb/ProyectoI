<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Personas.aspx.vb"
    Inherits="ProyectoI.Personas" %>
...
<asp:GridView ID="gvPersonas" CssClass="table table-striped table-hover table-success" runat="server" AutoGenerateColumns="False"
    DataSourceID="SqlDataSource" DataKeyNames="Cedula" OnRowDeleting="gvPersonas_RowDeleting" 
...
<asp:SqlDataSource ID="SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:Proyecto-Progra3ConnectionString %>" ProviderName="<%$ ConnectionStrings:Proyecto-Progra3ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [Persona]"></asp:SqlDataSource>
</asp:Content>
